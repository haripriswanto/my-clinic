...
?>
  ...
  <form id="buyingFilterReport" action="pages/report/selling/printing.php" target="_blank" method="POST" role="form"> 
      ...
      <div class="col-md-12"> 
        <div class="form-group">
            ...
            <select name="report_type" id="report_type" class="form-control tooltips" title="Jenis Laporan">
              ...
              <option value="2">Laporan Penjualan Detail</option>
              <option value="3">Laporan Penjualan Per Produk</option>
          </select>
        </div>
      </div>
      <div class="col-md-8"> 
      ...
      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">             
        <div class="form-group">
            ...
            <select name="product_category" id="product_category" class="form-control tooltips"data-toggle="tooltip" data-placement="top" title="Jika Kategori Kosong Maka Muncul Semua Kategori Produk">
              <option value="">-- Pilih --</option>
              <?php 
      ...
      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">             
        <div class="form-group">
            <label>Produk</label>
            <select name="product_name" id="product_name" class="form-control tooltips"data-toggle="tooltip" data-placement="top" title="Jika Nama Produk Kosong Maka Muncul Semua Nama Produk">
      ...
      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">             
        <div class="form-group">
            ...
            <select name="casier_name" id="casier_name" class="form-control tooltips"data-toggle="tooltip" data-placement="top" title="Jika Nama Admin Kosong Maka Muncul Semua Admin" >
      ...
      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">             
        <div class="form-group">
            ...
            <select name="payment_type" id="payment_type" class="form-control tooltips" title="Jika Cara Bayar Kosong Maka Muncul Semua Jenis Bayar" >
...
<script type="text/javascript">
   ...
   // $(".chosen-select").chosen({no_results_text: "yang anda cari tidak tersedia!"});
  ...
  // TOOLTIP
      ...
      function fetch_select(val){
         $.ajax({
         type: 'get',
         url: 'pages/report/selling/product_select.php',
         data: {
          get_option:val
         },
    ...
    $(document).ready(function() {
      $('#product_category').change(function() { 
        ...
        $.ajax({
          type: 'GET', 
          url: '<?php echo $base_url."pages/report/selling/product_select.php" ?>', 
