...
<div class="row">
  <div class="col">
    <a data-toggle="modal" href='#insert' id="buttonAdd" title="Tambah Data Kategori" class="btn btn-primary">
  ...
  <div class="col">
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="panel-title"><b>Data Kategori</b> 
        </h3>
      </div>
...
<script type="text/javascript">
  ...
  $('#insert').on('show.bs.modal', function (e) {
      ...
      $.ajax({
          type : 'get',
          url : '<?php echo $base_url."pages/master/category/insert.php" ?>',
  ...
  $('#edit').on('show.bs.modal', function (e) {
      ...
      $.ajax({
          type : 'get',
          url : '<?php echo $base_url."pages/master/category/edit.php" ?>',
          data :  'idEdit='+ idEdit,
          success : function(data){
  ...
  $('#delete').on('show.bs.modal', function (e) {
      ...
      $.ajax({
          type : 'get',
          url : '<?php echo $base_url."pages/master/category/confirm.php" ?>',
  ...
  function loadData(){
    ...
    $('#resultHandler').load('<?php echo $base_url."pages/master/category/read.php"?>');
  }
...
<?php 
  // log Activity
  $insertLogData = log_insert('READ', 'Akses Menu Master Kategori', $ip_address, $os, $browser);
