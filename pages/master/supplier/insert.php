...
<script type="text/javascript">
  ...
  function saveSupplier(){
    ...
    if ($('#auto_number').val() == '') {
      if ($('#supplier_code').val() == '') {
        toastr['error']("Kode supplier Tidak Boleh Kosong!");
        $('#supplier_code').focus();
      }
      ...
      toastr['error']("Pilih Jenis supplier Dulu!");
      $('#supplier_type').focus();
  ...
  // if ($('#auto_number').val() == '') {
    $('#supplier_code').keyup(function(e) {
      if(e.keyCode == 13) {
        if ($('#supplier_code').val() == '') {
          toastr['error']("Kode supplier Harus Di Isi!");
          $('#supplier_code').focus();
  ...
  $('#supplier_name').keyup(function(e) {
    if(e.keyCode == 13) {
      if ($('#supplier_name').val() == '') {
        toastr['error']("Nama supplier Harus Di Isi!");
        $('#supplier_name').focus();
  ...
  $('#supplier_type').change(function(e) {
    if ($('#supplier_type').val() == '') {
      toastr['error']("Pilih Gender supplier Dulu!");
      $('#supplier_type').focus();
