...
<div class="row">
    <div class="col-lg-12">
        <a href="#" data-toggle="modal" data-target="#insertPatient" class="btn btn-primary"> 
...
<div class="modal fade fade-modal" style="width: 100%" id="insertPatient">
...
<style type="text/css">
    ...
    function loadListPatient(){loading();$("#listPatient").load('pages/reg/reg-patient/listPatient.php')};
