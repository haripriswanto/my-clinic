...
<div class="panel-body">
  ...
  <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
    <div class="form-group">
      ...
      <select name="i_product_category" id="i_product_category" class="form-control" title="Kategori">
        ...
        <?php 
          $querySelectCategory = mysqli_query("SELECT * FROM tb_master_category WHERE bl_state = 'A' AND outlet_code_relation = '$system_outlet_code' ORDER BY category_description ASC");
  ...
  <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
    <div class="form-group">
      ...
      <select name="i_product_unit" id="i_product_unit" class="form-control" title="Satuan">
        ...
        <?php 
          $querySelectUnit = mysqli_query("SELECT * FROM tb_master_unit WHERE bl_state = 'A' AND outlet_code_relation = '$system_outlet_code' ORDER BY unit_description ASC");
  ...
  <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
    <div class="form-group">
      ...
      <div class="checkbox">
        <label>
          <input type="checkbox" name="i_product_stockable" id="i_product_stockable">
          Stockable
        </label>
      </div>
    </div>
 ...
 <!--  <script>
    var input = document.getElementById('i_product_price_buy');
...
<script type="text/javascript">
  ...
  function saveData(){
    ...
    if ($('#i_product_code').val() == '') {
      $.notify("Kode Produk Harus Diisi!", "error");
      $('#i_product_code').focus();
