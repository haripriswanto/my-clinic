      ...
      <div class="col-md-3">
        <div class="form-group" id="code">
          ...
          <div class="input-group">
            <input type="text" class="form-control tooltips" id="i_rm" name="i_rm" placeholder="No RM" title="Pencarian dengan RM / NIK / No. Asuransi / Nama" onkeyup="autoFill();">
      ...
      <script>
        function autoFill() {
          ...
          if (e.keyCode == 13) {
            var i_rm = $("#i_rm").val();
            $.ajax({
              url: '<?php echo $base_url . 'pages/reg/reg-patient/searchData.php'; ?>',
              method: post,
              data: "i_rm=" + i_rm,
              ...
              $('#i_rm').val(obj.i_rm);
              $('#i_nik').val(obj.i_nik);
              $('#i_insurance_number').val(obj.i_insurance_number);
              $('#i_insurance_name').val(obj.i_insurance_name);
              $('#i_full_name').val(obj.i_full_name);
              $('#i_title').val(obj.i_title);
              $('#i_status').val(obj.i_status);
            });
          })
        }
      </script>
      ...
      <div class="col-md-3">
        <div class="form-group">
          ...
          <select class="form-control tooltips" name="i_dokter_name" id="i_dokter_name" title="Nama Dokter">
            <?php $selectDokter = mysqli_query($config, "SELECT * FROM tb_master_dokter WHERE bl_state <> 'D' AND outlet_code_relation = '$system_outlet_code'");
            while ($rowDokter = mysqli_fetch_array($selectDokter)) { ?>
