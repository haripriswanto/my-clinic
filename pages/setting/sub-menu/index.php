<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">System SUBMENU</h1>
    </div>
</div>

<div class="row">
  <div class="col-md-12">
    <a data-toggle="modal" href='#insertForm' id="buttonAdd" title="Tambah Data" class="btn btn-primary">
      <span class="fa fa-plus-circle"></span> Tambah
    </a>
    <a href='<?= $base_url."menu"; ?>' id="menu" title="Daftar menu" class="btn btn-primary">
      <span class="fa fa-tasks"></span> Menu
    </a>
  ...
  <div class="col-md-12">
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="panel-title"><b>DATA SUB MENU</b> 
        </h3>
      </div>
...
function loadData(){
  ...
  $("#fetchData").load('<?php echo $base_url."pages/setting/sub-menu/read.php" ?>');
}
...
$('#insertForm').on('show.bs.modal', function (e) {
  ...
  $("#fetchFormInsert").html("<center><img src='<?php echo $base_url."assets/images/load.gif" ?>' width='50' height='50'/><i> Sedang Proses ...</i></center>");
    $.ajax({
        type : 'post',
        url : '<?php echo $base_url."pages/setting/sub-menu/insert.php" ?>',
...
$('#editFormMenu').on('show.bs.modal', function (e) {
  ...
  // LOADING
    ...
    $.ajax({
        type : 'get',
        url : '<?php echo $base_url."pages/setting/sub-menu/edit.php" ?>',
        data :  'idEdit='+idEdit,
        success : function(data){
...
$('#deleteConfirmMenu').on('show.bs.modal', function (e) {
  ...
  // LOADING
    ...
    $.ajax({
        type : 'post',
        url : '<?php echo $base_url."pages/setting/sub-menu/confirm.php" ?>',
        data :  'del_id='+ del_id,
        success : function(data){
