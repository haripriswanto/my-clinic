...
if (!$config) {
	echo " <h1 align='center'> ERROR CONNECT TO DATABASE!</h1> ";exit();
}
else{
    ...
    if ($hour>=0 && $hour<=12){ $ucapan = "Selamat Pagi"; }
    elseif ($hour >12 && $hour<=14){ $ucapan = "Selamat Siang "; }
    elseif ($hour >14 && $hour<=18){ $ucapan = "Selamat Sore "; }
    elseif ($hour >18 && $hour<=23){ $ucapan = "Selamat Malam "; }
